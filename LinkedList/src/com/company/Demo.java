...
public class Demo {
    public static void main(String[] args) {
        //[Sydney, Melbourne, Brisbane, Perth, Canberra, Adelaide, Darwin]
    ...
    private static boolean addInOrder(LinkedList<String> placesToVisit, String newCity) {
        ...
        //The LinkedList Array must have at least one element fot this while loop to execute
        //If the array is empty it does not execute
        while (stringListIterator.hasNext()) {
            int comparison = stringListIterator.next().compareTo(newCity);
            if (comparison == 0) {
                //newCity and element of array are equal, do not add
