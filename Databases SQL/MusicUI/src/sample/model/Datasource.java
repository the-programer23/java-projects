...
public class Datasource {
    ...
    public static final String CONNECTION_STRING =
            "jdbc:sqlite:C:\\Users\\FabianCreadorApps\\googleDrive\\Projects\\Java\\Databases SQL\\music\\" + DB_NAME;
    ...
    public String QUERY_ARTIST_FOR_SONG_START =
...
//    SELECT name, album, track FROM artist_list WHERE title = "Go Your Own Way"QUERY_VIEW_SONG_INFO
    //Prone to query injection attack
    ...
    //Query injection safe query
    public static final String QUERY_VIEW_SONG_INFO_PREP = "SELECT " + COLUMN_ARTIST_NAME + ", " + COLUMN_ALBUM_NAME + ", " +
            COLUMN_SONG_TRACK + " FROM " + TABLE_ARTIST_SONG_VIEW + " WHERE " + COLUMN_SONG_TITLE + " = ?";
    ...
    //This PreparedStatement is used because of the ? in QUERY_ALBUMS_BY_ARTIST_ID to avoid query injection
    ...
    public List<Artist> queryArtists(int sortOrder) {
        ...
        try(Statement statement = conn.createStatement();
            ...
            while (results.next()){
                //This simulates a delay in the database while fetching the data
                try{
                    Thread.sleep(20);
    ...
    public List<Album> queryAlbumsForArtistId(int id){
        try{
            //1 means the first ? and the id replaces the ? in the query
    ...
    public boolean updateArtistName(String newName, int id){
        try{
